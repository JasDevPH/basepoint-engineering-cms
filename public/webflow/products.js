...
var PAGE_DESC =
  "Pre-engineered manufacturing drawings for below-the-hook lifting devices. PE-stamped spreader bars, lifting beams, crane jibs, forklift attachments, and baskets. Basepoint Engineering.";
  ...
  try {
    ...
    var schema = {
      ...
      about: {
        ...
        image:
          "https://cdn.prod.website-files.com/691b593e94604e4077935ec5/691c378f9ddfcd2a59257a10_Basepoint_logo_default.png",
        address: {
          "@type": "PostalAddress",
    ...
    console.log(
      "✓ Product CollectionPage schema injected (" +
        products.length +
        " products)",
    );
  } catch (err) {
